...
exports.safeCall = exports.concurrentMap = exports.AsyncQueue = exports.ClosedQueueError = exports.createFuture = void 0;
...
async function* concurrentMap(concurrency, stream, f) {
    ...
    map().then(() => queue.close(), err => queue.tryPut({ promise: Promise.reject(err) }));
