...
import { ArchiveProviderEVM, ArchiveProviderSubstrate, ArchiveRegistryEVM, ArchiveRegistrySubstrate, NetworkSubstrate } from '.';
...
export declare function lookupArchive(network: string): string;
/**
...
export declare function lookupArchive(network: string, opts: LookupOptionsSubstrate): string;
/**
 * Lookup providers matching the optional filtering criteria in a given Substrate or EVM registry
 * @param network network name for lookup
...
export declare function lookupArchive(network: string, opts: LookupOptionsEVM): string;
/**
 * Lookup providers matching the optional filtering criteria in a given Substrate registry
 *
 * @param network network name for lookup
...
export declare function getGenesisHash(endpoint: string): string;
